...
The virgin-pool pair/input fusion is complete: the already-required 8-byte pair
seed remains the sole shared identity source, while narrow phase expands it into
