...
int main( void )
{
	...
	printf( "bodies,repeats,cpu_ms,gpu_ms,metal_kernel_ms,finalization_readback_bytes,finalization_readback_bypasses,"
		...
		"body_state_uploads,body_state_reuses,last_body_state_upload_bytes,body_state_revision_checks,last_body_state_readback_bytes,"
	...
	for ( int testIndex = 0; testIndex < testCount; ++testIndex )
	{
		...
		printf( "%d,%d,%.6f,%.6f,%.6f,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%.6f,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%.3f\n",
			bodyCount,
			repeats, cpuMs, gpuMs,
