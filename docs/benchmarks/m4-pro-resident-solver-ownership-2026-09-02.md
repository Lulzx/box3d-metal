...
Validated on the Apple M4 Pro with the float and double/VF64 Metal Werror builds,
plus the repository CPU and sanitizer gates recorded with the source checkpoint.
