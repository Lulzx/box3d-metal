...
def quickstart_story():
    return [
        ...
        *bullets(["Apple Silicon Mac and macOS Metal", "Xcode command-line tools", "Git, CMake, and Ninja"]),
        ...
        p("Dispatch counters prove a Metal stage ran. They do not imply that broad phase, narrow phase, CCD, sleeping, events, or finalization ran on the GPU.", "callout"),
...
def compatibility_story():
    ...
    return [
        ...
        *bullets([
            ...
            "Finalization, bounds, events, islands, sleeping, and CCD",
...
def performance_story():
    ...
    return [
        ...
        *bullets([
            ...
            "CPU finalization substantially reduces the fused primitive advantage.",
        ...
        *bullets([
            "Move finalization and bounds into the existing command graph.",
            "Retain body and supported-joint state across world steps.",
            "Add joint types only with mode matrices and whole-world evidence.",
            "Prototype GPU broad/narrow phase after ownership boundaries are reduced.",
        ]),
    ]
