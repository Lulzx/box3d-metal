...
The float and double/VF64 Metal Werror builds and focused Metal suites passed on
the Apple M4 Pro. Repository-wide CPU and sanitizer gates are recorded with the
source checkpoint. Timing was deliberately omitted because the host was not
quiet enough for a defensible end-to-end comparison.
